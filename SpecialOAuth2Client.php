 ...
 * Based on TwitterLogin by David Raison, which is based on the guideline published by Dave Challis at
 * http://blogs.ecs.soton.ac.uk/webteam/2010/04/13/254/
...
class SpecialOAuth2Client extends SpecialPage
{
    ...
    protected function _userHandling($response)
    {
        ...
        $id = $response[$wgOAuth2Client['configuration']['id']];
